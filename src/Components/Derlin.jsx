...
function Derlin() {
    return (
        <div className=" mt-40 w-full flex flex-col justify-center items-center ">
            ...
            <div className="flex flex-col z-50 text-white justify-center items-center absolute top-[46%] md:top-[38%] lg:top-[30%]">
                ...
                <div className="my-2 flex md:gap-4 gap-2  flex-col lg:gap-4 flex-wrap justify-center items-center w-screen   text-white  ">
                    ...
                    <div className="flex text-lg md:text-xl lg:text-xl gap-4">
